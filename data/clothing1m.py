...
class clothing_dataset(Dataset):
    def __init__(self, root, transform, mode, num_samples=64000, num_class=14):
...
class clothing_dataloader():
    ...
    def run(self, mode):
        ...
        if mode == 'train':
            train_dataset = clothing_dataset(self.root, transform=self.transform_train, mode='train')
    ...
    def get_train_dataset(self,mode):
        if mode == 'train':
            train_dataset = clothing_dataset(self.root, transform=self.transform_train, mode='train')
        return train_dataset
    def get_test_dataset(self,mode):
        if mode == 'test':
            test_dataset = clothing_dataset(self.root, transform=self.transform_train, mode='test')
        return test_dataset